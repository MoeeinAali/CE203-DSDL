...
طرح روی \lr{Intel Quartus Prime Lite Edition 21.1.0} با موجودیت سطح‌بالای \lr{stack} سنتز و Place \& Route شد. دستگاه هدف: \lr{Cyclone V} (\lr{5CGXFC7C7F23C8}).
...
{مورد} & {نتیجه} \\
\midrule
وضعیت کامپایل & موفق ($0$ خطا، $2$ هشدار) \\
\lr{Logic utilization (ALMs)} & $22 / 56480$ ($<1\%$) \\
\lr{Total registers} & $36$ \\
\lr{Total pins} & $14 / 268$ ($5\%$) \\
