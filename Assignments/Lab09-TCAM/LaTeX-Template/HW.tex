...
طرح روی \lr{Intel Quartus Prime Lite Edition 21.1.0} با موجودیت سطح‌بالای \lr{tcam} سنتز و Place \& Route شد. دستگاه هدف: \lr{Cyclone V} (\lr{5CGXFC7C7F23C8}).
...
\lr{Logic utilization (ALMs)} & $353 / 56480$ ($<1\%$) \\
\lr{Total registers} & $528$ \\
\lr{Total pins} & $119 / 268$ ($44\%$) \\
